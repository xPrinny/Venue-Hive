<?php 
    ...
    $stmt = $conn->prepare("SELECT a.listingId, a.listingName, a.listingPrice, b.username FROM venuehive.listings a INNER JOIN venuehive.members b on a.listingOwnerId = b.memberId LIMIT 10;");
    $stmt->execute();
